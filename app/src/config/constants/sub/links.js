...
const LINKS = {
  ...
  //Chrome — self-hosted instances ship the unpacked build at /extension.zip
  //served by the SPA's nginx (see docker/Dockerfile.app). Any code that
  //sends a user "to install the extension" lands on the local download.
  CHROME_EXTENSION:
