...
// In self-host there's no checkout flow — pass null to loadStripe so it resolves
// without injecting the https://js.stripe.com/v3 script into the page.
const stripePromise = isSelfHosted()
  ? Promise.resolve(null)
  : loadStripe(process.env.VITE_REACT_APP_STRIPE_PUBLISHABLE_KEY);
