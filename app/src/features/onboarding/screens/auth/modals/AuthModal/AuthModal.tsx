...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  // In self-host the SelfHostedAuthForm handles both login and signup inline; never
  // bounce signup to the OAuth URL (which is a 404 here anyway).
  const isWebAppSignup = !isSelfHosted() && isWebApp && authMode === APP_CONSTANTS.AUTH.ACTION_LABELS.SIGN_UP;
