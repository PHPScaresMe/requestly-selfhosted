...
//google signIn client libary for fetching user cred. Self-host uses email/password
//only — load a non-existent URL so `useScript` resolves to error without making a
//real request.
const googleSignInScriptURL: string = isSelfHosted()
  ? ""
